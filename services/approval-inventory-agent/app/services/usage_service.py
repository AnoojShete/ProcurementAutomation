...
# APP_SSO_LOG_PATH is set in the Dockerfile (the image has no repo root to
# walk up to); the relative fallback is for running from a checkout.
_SSO_LOG_PATH = os.environ.get("APP_SSO_LOG_PATH") or os.path.join(
