...
class ApprovalWorkflow:
    ...
    async def run(self, request_id: str) -> dict:
        ...
        if request["request_type"] == "reclaim":
            ...
            # Whatever arrived during the grace period isn't a chain decision.
        ...
        for i, approver_id in enumerate(approval_chain):
            ...
            # The signal is cleared right after it's consumed (below), not
            # here: clearing it before waiting would drop a decision that
